            ...
            <div class="col-md-12 ">
              <div class="grid simple form-grid">
                ...
                <div class="grid-body no-border">
                  <form action="{{route('updateItem')}}" id="form_traditional_validation" method="POST" name="form_traditional_validation"  autocomplete="off" class="validate">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control"  type="number" name="item_quantity" value="{{$item->item_quantity}}" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control"  type="number" name="item_price" value="{{$item->item_price}}" required>
                    </div>
                    @endforeach
                    </div>
