<div class="page-sidebar " id="main-menu">
        ...
        <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
          ...
          <ul>
            ...
            <li class="   "> <a href="index.html"><i class="material-icons">home</i> <span class="title">Staff</span> <span class="selected"></span> <span class="arrow  open "></span> </a>
              <ul class="sub-menu">
                <li ><a href="#"> <span class="title">Staff List</span> <span class="label label-important  "></span></a> </li>
                <li class=""> <a href="{{route('receptionClientList')}}"> Attendance </a></li>
              </ul>
            </li>
             <li>
