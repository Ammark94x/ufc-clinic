            ...
            <div class="col-md-12 ">
              <div class="grid simple form-grid">
                <div class="grid-title no-border">
                  <h4>Setting<span class="semi-bold"> Form</span></h4>
                  @if (session('status'))
                ...
                <div class="grid-body no-border">
                  <form action="{{route('addvideo')}}" id="form_traditional_validation" method="POST" name="form_traditional_validation"  autocomplete="off" class="validate">
                    {{csrf_field()}}
                    <div class="form-group">
                      <label class="form-label">Dashboard Video Link</label><span class="help"></span>
                      <input class="form-control" type="text" name="youtube_link" required>
                    </div>
                    </div>
